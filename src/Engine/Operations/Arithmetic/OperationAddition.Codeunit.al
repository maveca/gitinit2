...
/// </summary>
codeunit 50001 "Operation-Addition" implements IOperation
{
    /// <summary>
    /// Calculate.
    /// </summary>
    ...
    begin
        ...
        case true of
            ...
            LeftVariant.IsText() and RightVariant.IsText():
                exit(ConvertVariant.New(LeftVariant).AsText() + ConvertVariant.New(RightVariant).AsText());
            else
