/// <summary>
/// Codeunit OperationPlus (ID 50001) implements Interface IOperation.
/// </summary>
codeunit 50009 "Operation-Exponentiation" implements IOperation
{
    /// <summary>
    /// Calculate.
    /// </summary>
    ...
    begin
        ...
        case true of
            LeftVariant.IsInteger() and RightVariant.IsInteger():
                exit(System.Power(ConvertVariant.New(LeftVariant).AsInteger(), ConvertVariant.New(RightVariant).AsInteger()));
            LeftVariant.IsInteger() and RightVariant.IsDecimal():
                exit(System.Power(ConvertVariant.New(LeftVariant).AsInteger(), ConvertVariant.New(RightVariant).AsDecimal()));
            LeftVariant.IsDecimal() and RightVariant.IsInteger():
                exit(System.Power(ConvertVariant.New(LeftVariant).AsDecimal(), ConvertVariant.New(RightVariant).AsInteger()));
